...
contract FreezeLog {
    ...
    /// Recorder -> Index
    mapping(address => uint) public last_log_index;
    /// Recorder -> Index -> Log
    ...
    public
    {
        ...
        emit Recorded(msg.sender, last_log_index[msg.sender] - 1, _freezingGraceBlockCount);
    }
    ...
    public
    {
        ...
        require(
            storageLog.createdBlockNumber + storageLog.freezingGraceBlockCount >= block.number,
            "frozen"
        );
