...
class TestTransfer:
    ...
    def test_error_1(self, IbetCoupon, users, exchange):
        ...
        with brownie.reverts(revert_msg="1511"):
    ...
    def test_error_3(self, IbetCoupon, users, exchange):
        ...
        # transfer
        _value = 1
        with brownie.reverts(revert_msg="1512"):
            coupon.transfer.transact(_to, _value, {'from': _from})
    ...
    def test_error_4(self, IbetCoupon, IbetExchange, users,
        ...
        with brownie.reverts(revert_msg="1501"):
...
class TestBulkTransfer:
    ...
    def test_error_2(self, IbetCoupon, users, exchange):
        ...
        # bulk transfer
        with brownie.reverts(revert_msg="1522"):
            coupon_contract.bulkTransfer.transact(
                [to_address, to_address],
                [deploy_args[2], 1],
                {'from': from_address}
    ...
    def test_error_3(self, IbetCoupon, users, exchange):
        ...
        # bulk transfer
        with brownie.reverts(revert_msg="1523"):
            coupon_contract.bulkTransfer.transact(
                [to_address],
                [1],
                {"from": from_address}
...
class TestTransferFrom:
    ...
    def test_error_1(self, users, IbetCoupon, exchange):
        ...
        with brownie.reverts(revert_msg="1531"):
...
class TestConsume:
    ...
    def test_error_1(self, IbetCoupon, users, exchange):
        ...
        # consume
        with brownie.reverts(revert_msg="1541"):
            _value = deploy_args[2] + 1
...
class TestApplyForOffering:
    ...
    def test_error_1(self, IbetCoupon, users, exchange):
        ...
        # apply for
        with brownie.reverts(revert_msg="1551"):
