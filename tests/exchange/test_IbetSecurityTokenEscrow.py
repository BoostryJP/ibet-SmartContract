...
class TestCreateEscrow:
    ...
    def test_error_1(self, users, st_escrow):
        ...
        # create escrow
        with brownie.reverts(revert_msg="2401"):
            st_escrow.createEscrow(
                token.address,
                _recipient,
                0,
    ...
    def test_error_2(self, users, st_escrow):
        ...
        # create escrow
        with brownie.reverts(revert_msg="2402"):
            st_escrow.createEscrow(
                token.address,
                _recipient,
                _deposit_amount + 1,
    ...
    def test_error_3(self, users, st_escrow):
        ...
        # create escrow
        with brownie.reverts(revert_msg="2403"):
            st_escrow.createEscrow(
                token.address,
                _recipient,
                _escrow_amount,
...
class TestCancelEscrow:
    ...
    def test_error_1(self, users, st_escrow):
        ...
        # cancel escrow
        latest_escrow_id = st_escrow.latestEscrowId()
        with brownie.reverts(revert_msg="2411"):
    ...
    def test_error_2(self, users, st_escrow):
        ...
        # cancel escrow (2)
        with brownie.reverts(revert_msg="2412"):
            st_escrow.cancelEscrow(
                latest_escrow_id,
                {'from': _issuer}
            )
    ...
    def test_error_3(self, users, st_escrow):
        ...
        # cancel escrow
        latest_escrow_id = st_escrow.latestEscrowId()
        with brownie.reverts(revert_msg="2413"):
            st_escrow.cancelEscrow(
                latest_escrow_id,
                {'from': _recipient}
            )
    ...
    def test_error_4(self, users, st_escrow):
        ...
        # cancel escrow
        latest_escrow_id = st_escrow.latestEscrowId()
        with brownie.reverts(revert_msg="2414"):
            st_escrow.cancelEscrow(
                latest_escrow_id,
                {'from': _issuer}
            )
...
class TestApproveTransfer:
    ...
    def test_error_1(self, users, st_escrow):
        ...
        # approve transfer
        latest_escrow_id = st_escrow.latestEscrowId()
        with brownie.reverts(revert_msg="2421"):
    ...
    def test_error_2(self, users, st_escrow):
        ...
        # approve transfer
        latest_escrow_id = st_escrow.latestEscrowId()
        with brownie.reverts(revert_msg="2422"):
            st_escrow.approveTransfer(
                latest_escrow_id,
                _transfer_approval_data,
                {'from': _recipient}
    ...
    def test_error_3(self, users, st_escrow):
        ...
        # approve transfer
        with brownie.reverts(revert_msg="2423"):
            st_escrow.approveTransfer(
                latest_escrow_id,
                _transfer_approval_data,
                {'from': _issuer}
    ...
    def test_error_4(self, users, st_escrow):
        ...
        # approve transfer
        latest_escrow_id = st_escrow.latestEscrowId()
        with brownie.reverts(revert_msg="2424"):
            st_escrow.approveTransfer(
                latest_escrow_id,
                _transfer_approval_data,
                {'from': _issuer}
    ...
    def test_error_5(self, users, st_escrow):
        ...
        # approve transfer
        with brownie.reverts(revert_msg="2425"):
            st_escrow.approveTransfer(
                latest_escrow_id,
                _transfer_approval_data,
                {'from': _issuer}
...
class TestFinishEscrow:
    ...
    def test_error_1(self, users, st_escrow):
        ...
        # finish escrow
        latest_escrow_id = st_escrow.latestEscrowId()
        with brownie.reverts(revert_msg="2431"):
            st_escrow.finishEscrow(
                latest_escrow_id + 1,
                {'from': _agent}
            )
    ...
    def test_error_2(self, users, st_escrow):
        ...
        # finish escrow (2)
        with brownie.reverts(revert_msg="2432"):
            st_escrow.finishEscrow(
                latest_escrow_id,
                {'from': _agent}
            )
    ...
    def test_error_3(self, users, st_escrow):
        ...
        # finish escrow
        latest_escrow_id = st_escrow.latestEscrowId()
        with brownie.reverts(revert_msg="2433"):
            st_escrow.finishEscrow(
                latest_escrow_id,
                {'from': _recipient}
            )
    ...
    def test_error_4(self, users, st_escrow):
        ...
        # finish escrow
        latest_escrow_id = st_escrow.latestEscrowId()
        with brownie.reverts(revert_msg="2434"):
            st_escrow.finishEscrow(
                latest_escrow_id,
                {'from': _agent}
            )
...
class TestWithdraw:
    ...
    def test_error_1(self, users, st_escrow):
        ...
        # withdraw
        with brownie.reverts(revert_msg="2441"):
            st_escrow.withdraw(
                token.address,
                {'from': _issuer}
            )
