...
class TestLatestDeliveryId:
    ...
    def test_normal_1(self, users, st_dvp, st_dvp_storage):
        ...
        token = deploy(
            ...
            tradable_exchange=st_dvp.address
        )
...
class TestGetDelivery:
    ...
    def test_normal_1(self, users, st_dvp, st_dvp_storage):
        ...
        assert st_dvp.getDelivery(latest_delivery_id) == \
               st_dvp_storage.getDelivery(latest_delivery_id)
    ...
    def test_normal_2(self, users, st_dvp, st_dvp_storage):
        ...
        assert st_dvp.getDelivery(delivery_id) == \
               st_dvp_storage.getDelivery(delivery_id)
...
class TestBalanceOf:
    ...
    def test_normal_1(self, users, st_dvp, st_dvp_storage):
        ...
        assert st_dvp.balanceOf(_issuer, token.address) == \
               st_dvp_storage.getBalance(_issuer, token.address)
    ...
    def test_normal_2(self, users, st_dvp, st_dvp_storage):
        ...
        assert st_dvp.balanceOf(user1, token.address) == \
               st_dvp_storage.getBalance(user1, token.address)
...
class TestCommitmentOf:
    ...
    def test_normal_1(self, users, st_dvp, st_dvp_storage):
        ...
        assert st_dvp.commitmentOf(_issuer, token.address) == \
    ...
    def test_normal_2(self, users, st_dvp, st_dvp_storage):
        ...
        assert st_dvp.commitmentOf(_buyer, token.address) == \
...
class TestCreateDelivery:
    ...
    def test_normal_1(self, users, st_dvp):
        ...
        # assertion
        assert st_dvp.balanceOf(_issuer, token.address) == _deposit_amount - _delivery_amount
        assert st_dvp.commitmentOf(_issuer, token.address) == _delivery_amount
        latest_delivery_id = st_dvp.latestDeliveryId()
        assert st_dvp.getDelivery(latest_delivery_id) == (
            token.address,
    ...
    def test_normal_2(self, users, st_dvp):
        ...
        # assertion
        assert st_dvp.balanceOf(_issuer, token.address) == _deposit_amount - _delivery_amount * 2
...
class TestCancelDelivery:
    ...
    def test_error_1(self, users, st_dvp):
        ...
        with brownie.reverts(revert_msg="260101"):
            st_dvp.cancelDelivery(
                latest_delivery_id + 1,
                {'from': _issuer}
            )
...
class TestBulkFinishDelivery:
    ...
    def test_normal_1_2(self, users, st_dvp):
        ...
        # assertion
        assert st_dvp.balanceOf(_issuer, token.address) == _deposit_amount - _delivery_amount * 100
    ...
    def test_error_1_2(self, users, st_dvp):
        ...
        with brownie.reverts(revert_msg="260301"):
            tx = st_dvp.bulkFinishDelivery(
                [latest_delivery_id, latest_delivery_id + 1],
                {"from": _agent}
            )
            assert "DeliveryFinished" not in tx.events
            assert "HolderChanged" not in tx.events
    ...
    def test_error_2_2(self, users, st_dvp):
        ...
        with brownie.reverts(revert_msg="260302"):
            tx = st_dvp.bulkFinishDelivery(
                [valid_delivery_id, latest_delivery_id],
                {"from": _agent}
            )
            assert "DeliveryFinished" not in tx.events
            assert "HolderChanged" not in tx.events
    ...
    def test_error_4_2(self, users, st_dvp):
        ...
        with brownie.reverts(revert_msg="260304"):
            tx = st_dvp.bulkFinishDelivery(
                [latest_delivery_id_1, latest_delivery_id_2],
                {"from": _agent}
            )
            assert "DeliveryFinished" not in tx.events
            assert "HolderChanged" not in tx.events
    ...
    def test_error_5_2(self, users, st_dvp):
        ...
        # assertion
        assert st_dvp.balanceOf(_issuer, token_1.address) == _deposit_amount - _delivery_amount
        ...
        assert st_dvp.balanceOf(_issuer, token_2.address) == _deposit_amount - _delivery_amount
    ...
    def test_error_6_2(self, users, st_dvp):
        ...
        # set transferApprovalRequired to True
        token_1.setTransferApprovalRequired(
            True,
            {"from": _issuer}
        )
