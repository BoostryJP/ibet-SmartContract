...
# エラー系2: 新規登録 -> BAN -> 更新
def test_changeInfo_error_2(web3,chain):
    account_address = web3.eth.accounts[0]
    agent_address = web3.eth.accounts[1]
    ...
    # BAN -> Success
    web3.eth.defaultAccount = agent_address
    txn_hash_2 = whitelist_contract.transact().ban(account_address)
    chain.wait.for_receipt(txn_hash_2)
...
# 正常系1: 新規登録 -> BAN
def test_ban_normal_1(web3,chain):
    account_address = web3.eth.accounts[0]
    agent_address = web3.eth.accounts[1]
...
# エラー系1: 登録なし -> BAN
def test_ban_error_1(web3,chain):
    account_address = web3.eth.accounts[0]
    agent_address = web3.eth.accounts[1]
    ...
    with pytest.raises(TransactionFailed):
        web3.eth.defaultAccount = agent_address
        whitelist_contract.transact().ban(account_address)